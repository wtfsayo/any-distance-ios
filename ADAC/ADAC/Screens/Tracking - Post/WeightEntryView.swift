...
//                      unitChangeHandler: { data, unit in
//            return UnitConverter.value(UserDefaults.standard.bodyMassKg,
//                                       fromUnit: .kilograms,
//                                       toUnit: ADUser.current.massUnit).rounded()
//        },
        ...
        .onDisappear {
            Task(priority: .medium) {
                if bodyMass == 0.0 {
                    UserDefaults.standard.writeDefaultBodyMass()
                } else {
